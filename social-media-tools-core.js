(function initSocialMediaToolsCore(root) {
  ...
  const TOOL_CATALOG = Object.freeze([
    ["instagram-filter","Instagram","Bộ lọc ảnh","local"],["instagram-post","Instagram","Bài đăng & carousel","local"],["instagram-story","Instagram","Story 1080×1920","local"],["instagram-dm","Instagram","Mẫu DM có watermark","local"],["instagram-owned-media","Instagram","Media tài khoản đã kết nối","api"],
  ...
  const api = Object.freeze({ SCHEMA_VERSION, STORAGE_PREFIX, ROLES, JOB_STATES, PLATFORM_LIMITS, TOOL_CATALOG, clean, safeId, ownerIdFor, slug, filename, normalizeUrl, captionStats, formatCaption, buildUtm, buildOpenGraph, estimateXRevenue, parseVideoRef, roleCan, nextJobState, cropSize, createOAuthState, idempotencyKey, sha256, detectMime, defaultProject, storageKey, createStore });
