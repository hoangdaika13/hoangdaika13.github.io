...
test("Music AI assets are loaded by the page and offline worker", () => {
  ...
  for (const asset of ["music-production-suite.css?v=2", "music-production-suite.js?v=2", "creative-os-core.js?v=3", "music-daw-workspace.js?v=1", "music-composer-lyrics.js?v=1", "music-audio-labs.js?v=1", "music-mix-master.js?v=1", "music-visual-studio.js?v=1", "music-publishing-rights.js?v=1", "music-ai-studio.css?v=6", "music-ai-apps.css?v=2", "music-ai-apps.js?v=3", "music-ai-studio.js?v=9", "youtube-publisher.css?v=2", "youtube-publisher.js?v=2", "script.js?v=134", "app-shell.css?v=52"]) {
