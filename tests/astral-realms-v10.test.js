...
test("Character V10 route, offline assets and responsive UI are selected", () => {
  ...
  assert.match(worker, /hh-identity-portal-v287/);
  assert.match(index, /performance-loader\.js\?v=68/);
  assert.match(css, /Astral Realms Character V10/);
