...
test("HH Neon Gateway assets are wired into the application shell", () => {
  ...
  assert.match(read("auth-neon-gateway.js"), /auth-living-galaxy-3d\.js\?v=20/);
  assert.match(html, /auth-neon-gateway\.js\?v=33/);
  ...
  assert.match(worker, /auth-living-galaxy-3d\.js\?v=20/);
  assert.match(worker, /auth-neon-gateway\.js\?v=33/);
