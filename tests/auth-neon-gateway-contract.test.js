...
test("HH Neon Gateway assets are wired into the application shell", () => {
  ...
  assert.match(read("auth-neon-gateway.js"), /auth-living-galaxy-3d\.js\?v=22/);
  assert.match(html, /auth-neon-gateway\.js\?v=35/);
  assert.match(worker, /auth-neon-gateway\.css\?v=9/);
  assert.match(worker, /auth-h-galaxy\.css\?v=15/);
  assert.match(worker, /auth-h-galaxy\.js\?v=17/);
  assert.match(worker, /auth-living-galaxy-3d\.js\?v=22/);
  assert.match(worker, /auth-neon-gateway\.js\?v=35/);
