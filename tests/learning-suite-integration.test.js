...
test("Learning engines use the canonical /learn route namespace", () => {
  const paths = read("learning-paths.js");
  assert.doesNotMatch(paths, /["'`]\/learning\//, "stale /learning route bypasses the HH /learn router");
});
