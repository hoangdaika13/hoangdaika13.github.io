...
test("one-page family workspace exposes all requested content and accessibility contracts", () => {
  ...
  for (const asset of ["english-for-everyone.css?v=1", "english-for-everyone.js?v=2", "english-learning.js?v=24", "english-skill-graph.js?v=1", "english-skill-graph.css?v=1"]) assert.match(loader + serviceWorker, new RegExp(asset.replace(/[.?]/g, "\\$&")));
