...
test("navigation uses immediate positioning and calm assets are cache-busted", () => {
  ...
  for (const asset of ["motion-comfort.css?v=1", "script.js?v=149", "english-learning.js?v=17", "english-galaxy.css?v=1", "english-learning-galaxy.css?v=1", "english-learning-galaxy.js?v=1", "auth-experience.js?v=8"]) {
