...
test("navigation uses immediate positioning and calm assets are cache-busted", () => {
  ...
  for (const asset of ["motion-comfort.css?v=1", "script.js?v=165", "english-learning.js?v=19", "english-galaxy.css?v=1", "english-learning-galaxy.css?v=6", "english-learning-galaxy.js?v=4", "auth-experience.js?v=8"]) {
