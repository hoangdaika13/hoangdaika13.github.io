...
test("navigation uses immediate positioning and calm assets are cache-busted", () => {
  ...
  for (const asset of ["motion-comfort.css?v=1", "script.js?v=167", "english-learning.css?v=17", "english-learning.js?v=22", "english-galaxy.css?v=1", "english-galaxy.js?v=2", "english-learning-galaxy.css?v=6", "english-learning-galaxy.js?v=4", "english-vocabulary.css?v=1", "english-vocabulary.js?v=1", "english-for-everyone.css?v=1", "english-for-everyone.js?v=2", "auth-experience.js?v=8"]) {
