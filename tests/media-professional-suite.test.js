...
test("suite is loaded before the page, cached offline and responsive", () => {
  ...
  assert.match(loader, /media-professional-suite\.js\?v=3[\s\S]*media-tool-experience\.js\?v=2[\s\S]*media-project-photo-studio\.js\?v=4[\s\S]*media-production-universe\.js\?v=4[\s\S]*media-design-page\.js\?v=23/);
