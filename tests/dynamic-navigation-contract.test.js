...
test("new dynamic assets are cache-busted and available offline", () => {
  ...
  for (const asset of ["app-shell.css?v=54", "script.js?v=166", "sidebar-navigation-pro.css?v=9", "english-learning.css?v=17", "english-galaxy.css?v=1", "english-galaxy.js?v=2", "english-learning-galaxy.css?v=6", "english-learning-galaxy.js?v=4", "english-vocabulary.css?v=1", "english-vocabulary.js?v=1", "english-for-everyone.css?v=1", "english-for-everyone.js?v=2", "english-learning.js?v=22", "motion-comfort.css?v=1"]) {
