...
test("new dynamic assets are cache-busted and available offline", () => {
  ...
  for (const asset of ["app-shell.css?v=54", "script.js?v=156", "sidebar-navigation-pro.css?v=9", "english-learning.css?v=12", "english-galaxy.css?v=1", "english-galaxy.js?v=1", "english-learning-galaxy.css?v=1", "english-learning-galaxy.js?v=1", "english-learning.js?v=17", "motion-comfort.css?v=1"]) {
