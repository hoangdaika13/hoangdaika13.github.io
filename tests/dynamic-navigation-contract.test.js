...
test("new dynamic assets are cache-busted and available offline", () => {
  ...
  for (const asset of ["app-shell.css?v=52", "script.js?v=137", "sidebar-navigation-pro.css?v=6", "english-learning.css?v=11", "english-learning.js?v=16", "motion-comfort.css?v=1"]) {
