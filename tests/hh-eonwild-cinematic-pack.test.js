...
test("route-lazy integration loads the pack runtime before the game and preserves its separate cache", () => {
  const loaderIndex = html.indexOf('<script src="performance-loader.js?v=531"');
  ...
  const gameIndex = fs.readFileSync(path.join(root, "performance-loader.js"), "utf8").indexOf('"hh-eonwild-game.js?v=15"');
