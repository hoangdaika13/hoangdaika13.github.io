...
test("Graphic Design is a first-class application section", () => {
  ...
  for (const asset of ["graphic-design-studio.css?v=1", "graphic-design-animation.js?v=1", "graphic-design-3d.js?v=1", "graphic-design-prototype.js?v=1", "graphic-design-motion.js?v=1", "graphic-design-studio.js?v=1"]) {
