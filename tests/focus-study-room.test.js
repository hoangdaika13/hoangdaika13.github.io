...
test("router, lazy loader and responsive workspace are integrated", () => {
  ...
  assert.match(loader, /"focus-study-room": \{[\s\S]*?focus-room\.css\?v=5[\s\S]*?focus-room\.js\?v=5/);
  ...
  assert.match(index, /performance-loader\.js\?v=656/);
  assert.match(index, /script\.js\?v=274/);
  assert.match(worker, /performance-loader\.js\?v=656/);
