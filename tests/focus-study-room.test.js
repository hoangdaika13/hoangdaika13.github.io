...
test("router, lazy loader and responsive workspace are integrated", () => {
  ...
  assert.match(loader, /"focus-study-room": \{[\s\S]*?focus-room\.css\?v=1[\s\S]*?focus-room\.js\?v=1/);
  ...
  assert.match(index, /performance-loader\.js\?v=654/);
  assert.match(index, /script\.js\?v=274/);
  assert.match(worker, /performance-loader\.js\?v=654/);
  assert.match(worker, /script\.js\?v=274/);
