...
test("router, lazy loader and responsive workspace are integrated", () => {
  ...
  assert.match(loader, /"focus-study-room": \{[\s\S]*?focus-room\.css\?v=13[\s\S]*?focus-room\.js\?v=14/);
  ...
  assert.match(index, /performance-loader\.js\?v=664/);
  assert.match(index, /script\.js\?v=277/);
  assert.match(worker, /performance-loader\.js\?v=664/);
