...
test("Versioned assets are available offline", () => {
  ...
  for (const asset of ["communication-overview.css?v=1", "communication-overview.js?v=3", "search-platform-core.js?v=3", "search-quick-overlay.css?v=1", "search-quick-overlay.js?v=1", "google-hub.css?v=4", "google-hub.js?v=1", "google-hub-pro.css?v=3", "google-hub-pro.js?v=3", "youtube-hub.css?v=6", "youtube-playback-core.js?v=2", "youtube-hub.js?v=6", "youtube-hub-pro.css?v=5", "youtube-hub-pro.js?v=10"]) {
