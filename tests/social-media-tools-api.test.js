...
test("route, lazy loader, service worker and UI behavior are integrated", () => {
  ...
  assert.match(script,/route: "\/social-media-tools"/); assert.match(script,/HHSocialMediaTools\.mount/); assert.match(loader,/social-media-tools-core\.js\?v=3/); assert.match(loader,/social-media-tools-workspaces\.js\?v=4/); assert.match(sw,/social-media-tools-v2\.js\?v=4/);
