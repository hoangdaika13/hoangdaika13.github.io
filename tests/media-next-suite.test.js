...
test("Next suite is routed, cached, responsive and keeps real adapters capability-gated", () => {
  ...
  assert.match(loader, /media-professional-suite\.js\?v=3[\s\S]*vercel-blob-client\.min\.js\?v=1[\s\S]*media-next-suite\.js\?v=2[\s\S]*media-tool-experience\.js\?v=2[\s\S]*media-project-photo-studio\.js\?v=3[\s\S]*media-production-universe\.js\?v=3[\s\S]*media-design-page\.js\?v=22/);
