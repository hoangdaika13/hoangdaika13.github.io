...
test("EonWild v4 game composes versioned ecology and cinematic 3D APIs", () => {
  assert.equal(game.VERSION, "4.4.1");
  ...
  assert.equal(core3d.VERSION, "3.2.1");
  assert.equal(renderer3d.VERSION, "1.6.1");
...
test("lazy loader and service worker cache the complete ordered v4 bundle", () => {
  assert.match(loader, /game:\s*\{[\s\S]*?styles:\s*\["hh-eonwild-game\.css\?v=27"\][\s\S]*?scripts:\s*\["hh-eonwild-cinematic-pack\.js\?v=1",\s*"hh-eonwild-content-v2\.js\?v=3",\s*"hh-eonwild-species-registry\.js\?v=1",\s*"hh-eonwild-input-system\.js\?v=3",\s*"hh-eonwild-desktop-controller\.js\?v=3",\s*"hh-eonwild-collision-system\.js\?v=1",\s*"hh-eonwild-world-atlas\.js\?v=2",\s*"hh-eonwild-simulation-v2\.js\?v=4",\s*"hh-eonwild-3d-core\.js\?v=9",\s*"hh-eonwild-landscape-core\.js\?v=1",\s*"hh-eonwild-vegetation-system\.js\?v=1",\s*"hh-eonwild-environment-renderer\.js\?v=4",\s*"hh-eonwild-water-weather-system\.js\?v=1",\s*"hh-eonwild-renderer-3d\.js\?v=21",\s*"hh-eonwild-game\.js\?v=30"\]/);
  ...
  assert.match(worker, /const CACHE\s*=\s*"hh-identity-portal-v909"/);
