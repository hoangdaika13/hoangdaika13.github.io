...
test("DEV Pro Suite declares all thirteen professional workspaces", () => {
  ["smart-input", "developer-recipe", "api-studio", "mock-api", "json-data-lab", "security-encoding", "regex-studio", "database-playground", "code-playground", "git-diff-studio", "delivery-workflow", "web-diagnostics", "ai-developer"].forEach((id) => assert.match(source, new RegExp(`id: \\"${id}\\"`)));
});
