...
audio export|xuất tệp âm thanh`
  ...
  const additionalCategoryProfiles = {
    legal: { roles: ["Sinh vien luat", "Tro ly phap ly", "Chuyen vien tuan thu", "Luat su / quan ly"], skillProfile: { listening: 3, speaking: 4, reading: 5, writing: 5, vocabulary: 5 } },
    science: { roles: ["Sinh vien khoa hoc", "Ky thuat vien phong thi nghiem", "Nghien cuu vien", "Truong nhom nghien cuu"], skillProfile: { listening: 3, speaking: 3, reading: 5, writing: 5, vocabulary: 5 } },
    agriculture: { roles: ["Sinh vien nong nghiep", "Ky thuat vien hien truong", "Chuyen gia chuoi cung ung", "Quan ly trang trai"], skillProfile: { listening: 4, speaking: 4, reading: 4, writing: 4, vocabulary: 5 } },
    retail: { roles: ["Nhan vien ban hang", "Truong ca", "Chuyen vien thuong mai dien tu", "Quan ly cua hang"], skillProfile: { listening: 5, speaking: 5, reading: 3, writing: 3, vocabulary: 4 } },
    public: { roles: ["Sinh vien hanh chinh", "Nhan vien dich vu cong", "Chuyen vien chinh sach", "Quan ly co quan"], skillProfile: { listening: 4, speaking: 4, reading: 5, writing: 5, vocabulary: 5 } },
    sports: { roles: ["Nguoi hoc the thao", "Huan luyen vien", "Chuyen vien y hoc the thao", "Quan ly doi tuyen"], skillProfile: { listening: 5, speaking: 5, reading: 3, writing: 3, vocabulary: 4 } }
  };
  const additionalCategoryVocabulary = {
    legal: `contract clause|dieu khoan hop dong\nlegal advice|tu van phap ly\nregulatory requirement|yeu cau quy dinh\ncase law|an le\nconfidentiality agreement|thoa thuan bao mat\nlegal notice|thong bao phap ly\ncompliance review|ra soat tuan thu\nliability|trach nhiem phap ly\nsettlement|thoa thuan dan xep\nstatutory duty|nghia vu theo luat\nterms and conditions|dieu khoan va dieu kien\nproceedings|thu tuc to tung`,
    science: `research question|cau hoi nghien cuu\nliterature review|tong quan tai lieu\nhypothesis|gia thuyet\nexperimental design|thiet ke thi nghiem\ncontrol group|nhom doi chung\nreproducibility|kha nang tai lap\npeer review|phan bien dong cap\ndata integrity|tinh toan ven du lieu\nstatistical significance|y nghia thong ke\nresearch ethics|dao duc nghien cuu\nlab protocol|quy trinh phong thi nghiem\nresearch grant|tai tro nghien cuu`,
    agriculture: `crop rotation|luan canh cay trong\nsoil health|suc khoe dat\nirrigation system|he thong tuoi tieu\npest management|quan ly sau benh\nseed variety|giong cay\nyield forecast|du bao nang suat\nsupply chain|chuoi cung ung\nfood safety|an toan thuc pham\npost-harvest loss|ton that sau thu hoach\nsmart farming|nong nghiep thong minh\nweather resilience|kha nang chong chiu thoi tiet\nfarmer cooperative|hop tac xa nong dan`,
    retail: `product display|trung bay san pham\nstock level|muc ton kho\npoint of sale|diem ban hang\nreturn policy|chinh sach doi tra\ncustomer insight|hieu biet khach hang\nconversion rate|ty le chuyen doi\nonline checkout|thanh toan truc tuyen\nshopping cart|gio hang\npromotion code|ma khuyen mai\nrepeat purchase|mua lai\nvisual merchandising|trung bay thuong mai\norder fulfilment|xu ly don hang`,
    public: `public service|dich vu cong\npolicy brief|ban tom tat chinh sach\ncitizen feedback|phan hoi nguoi dan\npublic consultation|tham van cong chung\nservice eligibility|dieu kien huong dich vu\ncase management|quan ly ho so\ntransparency|tinh minh bach\nprocurement|mua sam cong\nbudget allocation|phan bo ngan sach\nimplementation report|bao cao trien khai\npublic accountability|trach nhiem giai trinh\nstakeholder engagement|gan ket ben lien quan`,
    sports: `training load|tai luong tap luyen\nmatch analysis|phan tich tran dau\nperformance goal|muc tieu thanh tich\nrecovery session|buoi phuc hoi\ninjury prevention|phong ngua chan thuong\nfitness assessment|danh gia the luc\nteam formation|doi hinh thi dau\ncompetitive mindset|tu duy canh tranh\nseason schedule|lich thi dau mua giai\nathlete welfare|phuc loi van dong vien\nperformance data|du lieu thanh tich\nstrength conditioning|ren suc manh va the luc`
  };
  const additionalTracks = [
    ["legal-compliance", "legal", "LAW", "Legal & Compliance", "Phap ly & tuan thu", "B1-C2", "Doc hop dong, giai thich quy dinh va giao tiep phap ly ro rang.", "review a compliance risk and explain the next action", "Viet ban ghi chu phap ly ngan gom van de, bang chung, rui ro va de xuat.", additionalCategoryVocabulary.legal],
    ["scientific-research", "science", "SCI", "Scientific Research", "Nghien cuu khoa hoc", "B1-C2", "Doc tai lieu, mo ta phuong phap va trinh bay ket qua nghien cuu.", "present reliable research findings to a mixed audience", "Trinh bay mot nghien cuu tu cau hoi, phuong phap, du lieu den gioi han.", additionalCategoryVocabulary.science],
    ["agri-food", "agriculture", "AGRI", "Agriculture & Food", "Nong nghiep & thuc pham", "A2-C1", "Giao tiep trong san xuat, chuoi cung ung va an toan thuc pham.", "coordinate a sustainable farm-to-market plan", "Mo ta ke hoach san xuat ben vung va cach giam rui ro sau thu hoach.", additionalCategoryVocabulary.agriculture],
    ["retail-ecommerce", "retail", "RETAIL", "Retail & E-commerce", "Ban le & thuong mai dien tu", "A2-C1", "Tu van khach hang, quan ly don hang va phan tich hieu qua ban hang.", "improve a customer journey and sales conversion", "De xuat cai tien cua hang hoac checkout dua tren du lieu khach hang.", additionalCategoryVocabulary.retail],
    ["public-administration", "public", "CIVIC", "Public Administration", "Hanh chinh cong", "B1-C2", "Xu ly ho so, viet bao cao va giao tiep minh bach voi cong dan.", "explain a public service process clearly and fairly", "Viet huong dan dich vu cong de nguoi dan de hieu va de thuc hien.", additionalCategoryVocabulary.public],
    ["sports-performance", "sports", "SPORT", "Sports & Performance", "The thao & thanh tich", "A2-C1", "Lam viec voi van dong vien, lich tap, phuc hoi va du lieu thanh tich.", "build and explain a safe performance plan", "Trinh bay chuong trinh tap luyen co muc tieu, tai tap va phuc hoi.", additionalCategoryVocabulary.sports]
  ].map(([id, category, code, name, viName, level, description, task, project, vocabulary]) => ({ id, category, code, name, viName, level, description, task, project, vocabulary }));
  const expansion = { categoryProfiles: { ...categoryProfiles, ...additionalCategoryProfiles }, categoryVocabulary: { ...categoryVocabulary, ...additionalCategoryVocabulary }, tracks: [...tracks, ...additionalTracks] };
