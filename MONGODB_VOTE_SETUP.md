...
5. Voi cluster hien tai cua ban, template dang la:
   `mongodb+srv://DB_USER:<db_password>@YOUR_CLUSTER.mongodb.net/?appName=YOUR_APP`
6. Thay cac gia tri mau bang thong tin trong MongoDB Atlas; khong dua ten user, hostname hay password that vao Git.
