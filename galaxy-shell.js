(function galaxyShellBootstrap(global) {
  ...
  const routeManifest = deepFreeze([
    ...
    { id: "project-hub", planet: "home", title: "Project Hub", route: "/work/projects-tasks", aliases: [], assetGroup: "galaxy-domain-views", layout: "three-column", capabilities: ["projects", "tasks", "local-storage"], adminOnly: false },
    { id: "automation-builder", planet: "home", title: "Automation Builder", route: "/work/automation-lab", aliases: [], assetGroup: "galaxy-domain-views", layout: "workbench", capabilities: ["workflow", "dry-run", "execution-log"], adminOnly: false },
    ...
    { id: "creator-studio", planet: "ai", title: "Creator Studio", route: "/create/workflow", aliases: [], assetGroup: "galaxy-domain-views", layout: "workbench", capabilities: ["creative-tools", "projects"], adminOnly: false },
    { id: "ai-universe", planet: "ai", title: "AI Universe", route: "/create/ai-center", aliases: [], assetGroup: "galaxy-home-ai", layout: "atlas", capabilities: ["ai-providers", "prompting"], adminOnly: false },
    ...
    { id: "community-showcase", planet: "community", title: "Community Showcase", route: "/communication/community", aliases: [], assetGroup: "galaxy-community-showcase", layout: "three-column", capabilities: ["community", "search", "filter", "realtime"], adminOnly: false },
    ...
    { id: "web-desktop", planet: "tools", title: "HH Web Desktop", route: "/system/desktop", aliases: [], assetGroup: "galaxy-web-desktop", layout: "desktop", capabilities: ["window-launcher", "local-preferences"], adminOnly: false },
  ...
  // HH Galaxy owns the twelve exact first-layer destinations.  The old
  // /galaxy aliases no longer bridge into Platform engines; only HH CORE may
  // cross that product boundary.
  const isImmersiveRoute = (input) => {
    const route = normalizeRoute(input);
    return route === "/home" || /^\/galaxy\/(ai|music|video|creator|games|dev|learning|community|tools|analytics|settings)$/.test(route);
  };
