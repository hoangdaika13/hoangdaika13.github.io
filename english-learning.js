(() => {
  ...
  const navItems = [
    ["dashboard", "⌂", "Hôm nay"], ["galaxy", "✦", "English Galaxy"], ["lab", "◌", "16 chế độ học"], ["plan", "✓", "Kế hoạch"], ["learn", "▶", "Bài học"], ["career", "▦", "Chuyên ngành"], ["practice", "✦", "Luyện tập"], ["placement", "◎", "Xếp lớp"], ["survey", "◈", "Khảo sát nghề"], ["vocabulary", "◇", "Sổ từ"],
    ["speaking", "◉", "Luyện nói"], ["writing", "✎", "Luyện viết"], ["progress", "↗", "Tiến độ"], ["settings", "⚙", "Cài đặt"]
  ];
  const beginnerNavIds = new Set(["dashboard", "galaxy", "lab", "learn", "vocabulary", "speaking", "progress"]);
  const navigatorGroups = [
    { id: "start", icon: "01", title: "Bắt đầu đúng chỗ", detail: "Kế hoạch, lộ trình và kiểm tra trình độ", views: ["galaxy", "plan", "learn", "placement"] },
    { id: "skills", icon: "Aa", title: "Luyện từng kỹ năng", detail: "Bài ngắn, có phản hồi và bước tiếp theo", views: ["lab", "practice", "vocabulary", "speaking", "writing"] },
  ...
  const render = (options = {}) => {
    ...
    if (state.activeView === "galaxy") content = galaxyView(state);
