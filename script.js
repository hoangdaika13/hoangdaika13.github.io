...
function initSuperPlatform() {
  ...
  const mediaCenterMarkup = () => {
    ...
    const defaults = [
      ...
      { id: "hh-profile", title: "Nhhoang · HH Neon Platform", type: "link", category: "gallery", url: "https://nhhoang13all.xyz", source: "Website", favorite: false }
    ];
