...
function initSuperPlatform() {
  ...
  window.HHCommunity={refresh:loadCommunityFeed,mutate:communityMutate,api:communityApi,state:ensureCommunityState,notice:communityNotice};
