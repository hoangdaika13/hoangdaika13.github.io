...
function initAppShell() {
  ...
  const groups = [
    ...
    { id: "english", label: "HH English", icon: "E", accent: "#60e9f2", route: "/english", items: [], pages: [{ id: "english-home", title: "Tổng quan", route: "/english" }, { id: "english-learn", title: "Lộ trình A0-C2", route: "/english/learn" }, { id: "english-placement", title: "Kiểm tra xếp lớp", route: "/english/placement" }, { id: "english-vocabulary", title: "Sổ từ vựng", route: "/english/vocabulary" }, { id: "english-speaking", title: "Phát âm", route: "/english/speaking" }, { id: "english-writing", title: "Luyện viết", route: "/english/writing" }, { id: "english-progress", title: "Tiến độ", route: "/english/progress" }] },
  ...
  const renderRoute = () => {
    ...
    if (route === "/home") {
      ...
      updatePageHeader("HH English", "Học tiếng Anh miễn phí từ mất gốc với lộ trình, luyện tập và tiến độ cá nhân.", route);
