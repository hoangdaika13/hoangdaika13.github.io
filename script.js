...
function initAppShell() {
  ...
  const renderRoute = () => {
    ...
    if (route === "/home") {
      ...
      updatePageHeader("HH Japanese OS V4", "42.301 từ/cụm nguồn mở, bốn lộ trình JLPT–JF–đời sống–nghề nghiệp, Conversation, Writing, Immersion và SRS V3.", route);
