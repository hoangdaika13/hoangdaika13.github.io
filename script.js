...
function initAppShell() {
  ...
  const groups = [
    ...
    { id: "chinese", label: "HH Chinese", icon: "中", accent: "#ffcf68", route: "/chinese", items: [] },
    {
      ...
      pages: [
        ...
        { id: "provenance", title: "Kiểm chứng nguồn", route: "/phat-phap/provenance", icon: "證" },
  ...
  const sidebarSearchAliases = Object.freeze({
    ...
    "phat-phap": "phật pháp phat phap giáo lý kinh điển study lab từ điển pali sanskrit hán việt thiền tụng niệm bản đồ giáo pháp chùa pháp thoại thỉnh kinh tu học đời sống kiểm chứng nguồn lịch thời khóa nhóm đọc riêng tư trợ năng ôn giáo lý thư viện nghe tủ dữ liệu sao lưu khôi phục",
