...
function initSuperPlatform() {
  ...
  window.HHCommunity={refresh:loadCommunityFeed,loadMode:loadCommunityFeedMode,mutate:communityMutate,api:communityApi,state:ensureCommunityState,notice:communityNotice};
