...
function initAppShell() {
  ...
  const renderRoute = () => {
    ...
    if (route === "/home") {
      ...
      updatePageHeader("HH Japanese", "Không gian học tiếng Nhật toàn diện: Từ điển Nhật–Việt, Kanji, ngữ pháp, đọc hiểu, JLPT N5–N1, SRS và hội thoại.", route);
