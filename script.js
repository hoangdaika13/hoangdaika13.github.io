...
function initAppShell() {
  ...
  const renderRoute = () => {
    ...
    if (route === "/home") {
      ...
      updatePageHeader("HH English", "Học miễn phí từ A0 đến C2 với 36 lộ trình nghề nghiệp, bài học hằng ngày và ôn từ thông minh.", route);
