...
function initAppShell() {
  ...
  const sidebarSearchAliases = Object.freeze({
    ...
    "phat-phap": "phật pháp phat phap giáo lý kinh điển canonical reader scholar ocr facsimile work version segment tìm kiếm học thuật study lab từ điển pali sanskrit hán việt thiền tụng niệm bản đồ giáo pháp chùa pháp thoại thỉnh kinh tu học đời sống kiểm chứng nguồn lịch thời khóa nhóm đọc riêng tư trợ năng ôn giáo lý thư viện nghe tủ dữ liệu sao lưu khôi phục",
