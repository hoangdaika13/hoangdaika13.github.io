(function () {
  ...
  const CATALOG = [
    ...
    },
    {
      ...
      title: "Neon Skyline Rush",
      short: "NS",
      route: "/entertainment/cinematic-arcade/neon-skyline-rush",
      genre: "Đua hovercar 3D điện ảnh",
      color: "#55eaff",
      status: "3D mới",
      release: "ready",
      realtimeEligible: false,
      description: "Lướt qua cao tốc trên không, né xe, xuyên cổng năng lượng và đổi camera chase/cockpit trong thành phố neon.",
      tags: ["3D", "Racing", "Camera", "Boost"],
      reward: { xp: 105, coins: 42 }
    },
    {
      id: "mecha-frontier",
      title: "Mecha Frontier",
      short: "MF",
      route: "/entertainment/cinematic-arcade/mecha-frontier",
      genre: "Đấu trường mecha 3D",
      color: "#ff6f91",
      status: "3D mới",
      release: "ready",
      realtimeEligible: false,
      description: "Điều khiển mecha bằng camera vai, khóa mục tiêu, bắn plasma và sống sót trước đội quân máy chiến đấu.",
      tags: ["3D", "Mecha", "Shooter", "Lock-on"],
      reward: { xp: 115, coins: 46 }
    },
    {
      id: "dragon-sky",
      title: "Dragon Sky",
      short: "DS",
      route: "/entertainment/cinematic-arcade/dragon-sky",
      genre: "Bay rồng 3D",
      color: "#a985ff",
      status: "3D mới",
      release: "ready",
      realtimeEligible: false,
      description: "Bay xuyên đảo nổi, luồn qua vòng mây, phun lửa phá tinh thể và làm chủ camera bay tự do.",
      tags: ["3D", "Flight", "Fantasy", "Exploration"],
      reward: { xp: 110, coins: 44 }
    },
    {
      id: "titan-protocol",
      title: "Titan Protocol",
      short: "TP",
      route: "/entertainment/cinematic-arcade/titan-protocol",
      genre: "Săn boss điện ảnh 3D",
      color: "#ffad57",
      status: "3D mới",
      release: "ready",
      realtimeEligible: false,
      description: "Đọc đòn Titan, dash qua sóng xung kích, phản công điểm yếu và theo dõi boss bằng camera lock-on động.",
      tags: ["3D", "Boss", "Dodge", "Cinematic"],
      reward: { xp: 130, coins: 52 }
    },
    {
      id: "crystal-expedition",
      title: "Crystal Expedition",
      short: "CE",
      route: "/entertainment/cinematic-arcade/crystal-expedition",
      genre: "Khám phá hành tinh 3D",
      color: "#72f4ac",
      status: "3D mới",
      release: "ready",
      realtimeEligible: false,
      description: "Khám phá thung lũng pha lê, thu thập cổ vật, kích hoạt beacon và ngắm địa hình bằng camera orbit mềm.",
      tags: ["3D", "Explore", "Collect", "Atmosphere"],
      reward: { xp: 100, coins: 40 }
    },
    {
      id: "hoverball-arena",
      title: "Hoverball Arena",
      short: "HA",
      route: "/entertainment/cinematic-arcade/hoverball-arena",
      genre: "Thể thao hover 3D",
      color: "#ffd96a",
      status: "3D mới",
      release: "ready",
      realtimeEligible: false,
      description: "Tăng tốc, va chạm quả cầu năng lượng và ghi bàn trong sân vận động hologram với camera thể thao tự động.",
      tags: ["3D", "Sports", "Physics", "Arena"],
      reward: { xp: 105, coins: 42 }
    },
    {
      id: "neon-drift",
      title: "Neon Drift",
      short: "ND",
      route: "/entertainment/arcade/neon-drift",
    ...
    },
    {
      ...
      short: "GD",
      route: "/entertainment/arcade/galaxy-defense",
      genre: "Thủ thành",
      color: "#ffe37a",
      status: "Arcade",
      release: "ready",
    ...
    },
    {
      ...
      title: "Star Colony",
      short: "SC",
      route: "/entertainment/arcade/star-colony",
    ...
    },
    {
      ...
      title: "Cipher Run",
      short: "CR",
      route: "/entertainment/arcade/cipher-run",
    ...
    },
    {
      ...
      short: "SO",
      route: "/entertainment/arcade/survival-orbit",
  ...
  function rewardPlayer(payload = {}) {
    ...
    if (payload.gameId) {
      ...
      const game = state.games.find((item) => item.id === safeGameId) || {
        ...
        route: `/entertainment/arcade/${encodeURIComponent(safeGameId)}`
      };
