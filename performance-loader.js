(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    game: {
      styles: ["game-runtime.css?v=1", "astral-realms.css?v=9", "space-explorer.css?v=4", "game-center.css?v=5", "astra-universe-expansion.css?v=4", "game-arcade.css?v=4"],
      scripts: ["game-platform-adapters.js?v=1", "game-runtime.js?v=1", "astral-realms.js?v=9", "space-explorer.js?v=4", "game-center.js?v=5", "astra-universe-expansion.js?v=4", "game-arcade.js?v=4"]
    },
