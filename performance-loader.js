  ...
  const groups = Object.freeze({
    ...
    davinci: {
      styles: [
        ...
        "editor-workflow-pro.css?v=2", "davinci-resolve-hub.css?v=4", "video-editor-auto.css?v=1", "h-cosmic-web-studio.css?v=1",
      ...
      scripts: [
        ...
        "davinci-resolve-hub.js?v=5", "video-editor-auto.js?v=1", "h-cosmic-web-studio.js?v=1",
