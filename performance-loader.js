(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    "home-enhancements": {
      styles: [
        "dashboard-aurora.css?v=4", "home-galaxy-command.css?v=8", "home-galaxy-mission.css?v=7", "home-galaxy-operations.css?v=1", "home-galaxy-control-deck.css?v=2", "command-center-pro.css?v=4", "home-daily-command.css?v=4",
      ...
      scripts: [
        ...
        "home-command-search.js?v=4", "home-widget-project-pulse.js?v=2", "home-health-focus.js?v=2", "home-galaxy-command.js?v=7"
      ]
    },
    platform: {
      styles: [
