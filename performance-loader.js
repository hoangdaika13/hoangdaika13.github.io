  ...
  const groups = Object.freeze({
    ...
    davinci: {
      styles: [
        ...
        "youtube-publisher.css?v=3", "youtube-creator-galaxy.css?v=2"
      ],
      scripts: [
        ...
        "youtube-publisher.js?v=4", "youtube-creator-galaxy.js?v=3"
      ]
    },
    graphic: {
    ...
    music: {
      ...
      scripts: [
        "creative-os-core.js?v=4", "youtube-publisher.js?v=4", "music-daw-workspace.js?v=1", "music-composer-lyrics.js?v=1",
    ...
    game: {
      styles: ["game-runtime.css?v=1", "astral-realms.css?v=5", "space-explorer.css?v=4", "game-center.css?v=5", "astra-universe-expansion.css?v=4", "game-arcade.css?v=4"],
      scripts: ["game-platform-adapters.js?v=1", "game-runtime.js?v=1", "astral-realms.js?v=5", "space-explorer.js?v=4", "game-center.js?v=5", "astra-universe-expansion.js?v=4", "game-arcade.js?v=4"]
    },
