(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    fortune: {
      styles: ["fortune-hub.css?v=3", "fortune-hub-v3.css?v=2", "fortune-hub-v4.css?v=2"],
      scripts: ["vendor/jszip.min.js?v=3.10.1", "vendor/pdf-lib.min.js?v=1.17.1", "vendor/astronomy-engine-2.1.19.min.js?v=1", "fortune-iching-64.js?v=1", "fortune-accuracy-lab.js?v=1", "fortune-suite-v4.js?v=2", "fortune-astrology.js?v=1", "fortune-astrology-v4.js?v=2", "fortune-hub.js?v=10"]
    },
    "chat-ai": {
