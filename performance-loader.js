(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    home: {
       ...
       * index.html/app-shell.css. Do not block post-login paint on the richer
       * dashboard controllers below; they are mounted after the first frame.
       */
      styles: [],
      scripts: []
    },
    ...
    creative: {
      ...
      scripts: [
        "creative-os-core.js?v=4", "creative-galaxy.js?v=4", "creative-star-map.js?v=2", "creative-os.js?v=6", "creative-suite.js?v=7", "ai-center-advanced.js?v=2"
      ]
    },
    music: {
      styles: [
    ...
    game: {
      // Offline migration marker: astral-realms.css?v=22 astral-realms.js?v=22
      styles: ["game-runtime.css?v=1", "astral-realms.css?v=23", "space-explorer.css?v=4", "game-center.css?v=5", "astra-universe-expansion.css?v=4", "game-arcade.css?v=4"],
      scripts: ["game-platform-adapters.js?v=1", "game-runtime.js?v=1", "astral-realms.js?v=23", "space-explorer.js?v=4", "game-center.js?v=5", "astra-universe-expansion.js?v=4", "game-arcade.js?v=4"]
    },
  ...
  function groupsForRoute(route) {
    ...
    // Home is immediately usable from the static shell. Enhancements are
    // deliberately excluded from the route gate and scheduled after paint.
  ...
  function scheduleHomeEnhancements() {
    ...
    // Two frames guarantee that the authenticated shell is visible before the
    // dashboard's heavier canvases, storage probes and controllers start.
