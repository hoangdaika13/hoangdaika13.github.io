  ...
  const groups = Object.freeze({
    ...
    davinci: {
      styles: [
        ...
        "video-batch-factory.css?v=4", "youtube-publisher.css?v=4", "youtube-creator-galaxy.css?v=20", "image-text-studio.css?v=10"
      ],
      scripts: [
        ...
        "youtube-publisher.js?v=7", "youtube-creator-galaxy.js?v=24", "vendor/jszip.min.js?v=3.10.1", "image-text-studio.js?v=10"
      ]
    },
    "comic-motion": {
