(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    "home-enhancements": {
      styles: [
        "dashboard-aurora.css?v=4", "home-galaxy-command.css?v=6", "home-galaxy-mission.css?v=7", "home-galaxy-operations.css?v=1", "home-galaxy-control-deck.css?v=2", "command-center-pro.css?v=4", "home-daily-command.css?v=4",
      ...
      scripts: [
        ...
        "home-command-search.js?v=4", "home-widget-project-pulse.js?v=2", "home-health-focus.js?v=2", "home-galaxy-command.js?v=5"
      ]
    },
    platform: {
      styles: [
    ...
    davinci: {
      // Image Text Studio cache compatibility: image-text-studio.css?v=10 image-text-studio.js?v=10
      styles: [
        ...
        "video-batch-factory.css?v=4", "youtube-publisher.css?v=4", "youtube-creator-galaxy.css?v=20", "image-text-studio.css?v=11", "facebook-page-command-center.css?v=3"
      ],
      scripts: [
        ...
        "youtube-publisher.js?v=7", "youtube-creator-galaxy.js?v=24", "vendor/jszip.min.js?v=3.10.1", "image-text-studio.js?v=11", "facebook-page-command-center.js?v=3"
      ]
    },
    "comic-motion": {
    ...
    "comic-reader": {
      ...
      scripts: ["vendor/jszip.min.js?v=3.10.1", "comic-open-source-catalog.js?v=2", "comic-reader-hub.js?v=18"]
    },
    graphic: {
