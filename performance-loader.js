(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    japanese: {
      styles: ["japanese-learning.css?v=8", "japanese-os-v3.css?v=4"],
      scripts: ["japanese-vocabulary-packs.js?v=1", "japanese-vocabulary-10k.js?v=1", "japanese-vietnamese-pack.js?v=1", "japanese-learning.js?v=8", "japanese-os-v3.js?v=2"]
    },
    analytics: {
