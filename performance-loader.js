(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    "galaxy-layer-one": {
      styles: ["galaxy-creator-studio.css?v=12", "galaxy-layer-one.css?v=7", "galaxy-layer-one-worlds.css?v=17", "galaxy-stable-chrome.css?v=4", "galaxy-premium-workspaces.css?v=2", "galaxy-workbench.css?v=4", "galaxy-cosmic-studio.css?v=1", "galaxy-living-universe.css?v=3"],
