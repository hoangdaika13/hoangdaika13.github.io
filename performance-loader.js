(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    game: {
      ...
      scripts: ["game-platform-adapters.js?v=1", "game-runtime.js?v=1", "astral-realms.js?v=71", "space-explorer.js?v=4", "game-center.js?v=5", "astra-universe-expansion.js?v=4", "game-arcade.js?v=4"]
    },
