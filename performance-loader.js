(function initHHAssetLoader(global) {
  ...
  const legacyAuthEffectAssets = Object.freeze([
    ...
    "auth-solar-secret.css?v=8", "auth-solar-secret.js?v=6"
  ]);
  ...
  const groups = Object.freeze({
    ...
    "galaxy-home-ai": {
      ...
      scripts: ["home-cosmos-motion.js?v=3", "galaxy-home-ai.js?v=18"]
    },
    "galaxy-layer-one": {
      styles: ["galaxy-creator-studio.css?v=12", "galaxy-layer-one.css?v=7", "galaxy-layer-one-worlds.css?v=16", "galaxy-stable-chrome.css?v=4", "galaxy-premium-workspaces.css?v=2", "galaxy-workbench.css?v=4", "galaxy-cosmic-studio.css?v=1", "galaxy-living-universe.css?v=2"],
    ...
    davinci: {
      ...
      styles: [
        ...
        "video-batch-factory.css?v=4", "youtube-publisher.css?v=4", "youtube-creator-galaxy.css?v=22", "image-text-studio.css?v=15", "facebook-page-command-center.css?v=4", "tiktok-creator-galaxy.css?v=2"
      ],
      scripts: [
    ...
    youtube: {
      styles: ["search-quick-overlay.css?v=1", "youtube-hub.css?v=6", "youtube-hub-pro.css?v=5"],
      scripts: ["search-platform-core.js?v=3", "search-quick-overlay.js?v=1", "youtube-playback-core.js?v=2", "youtube-hub.js?v=6", "youtube-hub-pro.js?v=10"]
    },
    discord: {
    ...
    // Previous cache keys retained for old clients: hh-chinese.css?v=1 · hh-chinese.js?v=1 · hh-chinese.css?v=11 · hh-chinese.js?v=11 · hh-chinese.css?v=13 · hh-chinese.js?v=13 · hh-chinese.css?v=14 · hh-chinese.js?v=14
    chinese: {
      styles: ["language-learning-cockpit.css?v=2", "hh-chinese.css?v=15"],
    ...
    cosmic: {
      ...
      scripts: ["vendor/astronomy-engine-2.1.19.min.js?v=1", "cosmic-solar-system-3d.js?v=3", "cosmic-observatory.js?v=5"]
    },
    play: {
