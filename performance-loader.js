  ...
  const groups = Object.freeze({
    ...
    davinci: {
      styles: [
        ...
        "video-batch-factory.css?v=2", "youtube-publisher.css?v=4", "youtube-creator-galaxy.css?v=3"
      ],
      scripts: [
        "media-design-studio.js?v=1", "video-editor-studio.js?v=5", "video-batch-factory.js?v=2",
