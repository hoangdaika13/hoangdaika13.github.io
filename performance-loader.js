(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    game: {
      styles: ["hh-eonwild-game.css?v=10"],
      scripts: ["hh-eonwild-content-v2.js?v=3", "hh-eonwild-simulation-v2.js?v=4", "hh-eonwild-3d-core.js?v=2", "hh-eonwild-renderer-3d.js?v=3", "hh-eonwild-game.js?v=11"]
    },
    fortune: {
