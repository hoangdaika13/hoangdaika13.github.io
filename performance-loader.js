(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    home: {
       ...
       */
      styles: [
        "dashboard-aurora.css?v=4", "command-center-pro.css?v=4", "home-daily-command.css?v=4",
        "home-command-search.css?v=2", "home-widget-project-pulse.css?v=2", "home-health-focus.css?v=2"
      ],
      scripts: [
        "dashboard-aurora.js?v=5", "command-center-pro.js?v=5", "home-daily-command.js?v=5",
