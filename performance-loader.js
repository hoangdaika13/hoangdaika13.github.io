(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    "social-media-tools": {
      styles: ["social-media-tools-v2.css?v=4"],
      scripts: ["vendor/jszip.min.js?v=3.10.1", "social-media-tools-core.js?v=3", "social-media-tools-workspaces.js?v=4", "social-media-tools-v2.js?v=4"]
    },
    "comic-motion": {
