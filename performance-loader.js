(function initHHAssetLoader(global) {
  ...
  const groups = Object.freeze({
    ...
    english: {
      styles: ["english-learning.css?v=16", "english-galaxy.css?v=1", "english-voice-coach.css?v=4", "english-learning-galaxy.css?v=6", "english-vocabulary.css?v=1"],
      scripts: ["english-curriculum.js?v=1", "english-career-expansion.js?v=1", "english-career-curriculum.js?v=2", "english-galaxy.js?v=2", "english-learning-galaxy.js?v=4", "english-vocabulary.js?v=1", "english-learning.js?v=20"]
    },
    japanese: {
