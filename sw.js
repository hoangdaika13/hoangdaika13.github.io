...
const RUNTIME_ASSETS = [
  ...
  "./galaxy-favicon-controller.js?v=1",
  "./assets/brand/hh-galaxy-star-static.svg?v=1",
  "./assets/brand/hh-galaxy-star.svg?v=1",
  "./assets/brand/favicon-16.png?v=1",
  "./assets/brand/favicon-32.png?v=1",
  "./assets/brand/favicon-48.png?v=1",
  "./assets/brand/apple-touch-icon.png?v=1",
