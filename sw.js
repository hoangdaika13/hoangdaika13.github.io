...
const RUNTIME_ASSETS = [
  ...
  "./kim-lien-shell.css?v=8",
  "./kim-lien-auth.css?v=13",
  "./kim-lien-home.css?v=3",
  "./kim-lien-workspaces.css?v=10",
  "./kim-lien-creative-learning.css?v=4",
  "./kim-lien-operations.css?v=6",
  "./kim-lien-runtime.js?v=2",
  "./kim-lien-workspaces.js?v=18",
  "./kim-lien-auth.js?v=6",
  "./kim-lien-home.js?v=2",
  "./assets/phat-phap/hh-kim-lien-mark.svg?v=1",
  "./assets/phat-phap/duc-phat-hao-quang-v1.webp",
  "./workspace-feature-explorer.css?v=3",
  ...
  "./graphic-design-node-effects.js?v=2",
  ...
  "./communication-workspace-fix.css?v=10",
  ...
  "./privacy-consent-center.css?v=6",
...
// Keep install atomic and fast: CORE contains only the route-independent shell,
// the four Kim Lien paint owners and the minimum boot/auth/router runtime.
// Everything else enters this cache on first use through stale-while-revalidate.
const CORE = [
  "./index.html",
  "./app-shell.css?v=65",
  "./kim-lien-theme.css?v=2",
