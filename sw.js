...
const RUNTIME_ASSETS = [
  ...
  "./kim-lien-shell.css?v=7",
  "./kim-lien-auth.css?v=8",
  "./kim-lien-home.css?v=3",
  "./kim-lien-workspaces.css?v=8",
  "./kim-lien-creative-learning.css?v=3",
  "./kim-lien-operations.css?v=6",
  "./kim-lien-runtime.js?v=2",
  "./kim-lien-workspaces.js?v=15",
  "./kim-lien-auth.js?v=5",
