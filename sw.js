const CACHE = "hh-identity-portal-v194";
...
const RUNTIME_ASSETS = [
  ...
  "./media-production-workflow.css?v=1",
  ...
  "./graphic-design-workflow.js?v=1",
  ...
  "./communication-intelligence.css?v=2",
  "./communication-intelligence.js?v=2",
  "./work-center.css?v=2",
  "./work-center.js?v=2",
  ...
  "./platform-p0.css?v=1",
  "./platform-p0.js?v=1",
  "./platform-orchestrator.js?v=1",
  "./system-platform.css?v=1",
  "./system-platform.js?v=1",
  ...
  "./creative-ai-workflow.css?v=2",
  "./creative-ai-workflow.js?v=2",
  ...
  "./media-production-workflow.js?v=1",
  "./editor-workflow-pro.js?v=1",
  "./support-platform.js?v=12",
