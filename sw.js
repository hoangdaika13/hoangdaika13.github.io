const CACHE = "hh-identity-portal-v178";
const CORE = [
  "./",
  "./index.html",
  "./app-shell.css?v=50",
  ...
  "./auth-zoom-resilience.css?v=2",
  "./assets/hh-neon-logo-v2.png?v=2",
  "./auth-platform.js?v=2",
  ...
  "./auth-quantum-flow.js?v=1",
  "./auth-trust-director.js?v=1",
  "./auth-zoom-resilience.js?v=2",
