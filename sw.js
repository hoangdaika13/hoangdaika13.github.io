const CACHE = "hh-identity-portal-v1021";
...
const RUNTIME_ASSETS = [
  ...
  "./galaxy-cosmic-studio.js?v=4", "./galaxy-living-universe.js?v=5", "./galaxy-living-universe.css?v=1", "./galaxy-universe-renderer.mjs?v=5",
