...
const CORE = [
  ...
  "./graphic-design-vector-core.js?v=1",
  "./graphic-design-state-machine.js?v=1",
  "./graphic-design-adaptive.js?v=1",
  "./graphic-design-project-store.js?v=2",
  "./graphic-design-collaboration.js?v=1",
  "./graphic-design-dev-ai.js?v=1",
  ...
  "./graphic-design-components.js?v=1",
  "./graphic-design-color-pro.js?v=1",
  "./graphic-design-export-center.js?v=1",
  "./graphic-design-plugins.js?v=1",
  "./graphic-design-review.js?v=1",
