const CACHE = "hh-identity-portal-v197";
...
const RUNTIME_ASSETS = [
  ...
  "./platform-module-bridge.js?v=1",
  "./system-platform.css?v=1",
  "./system-platform.js?v=2",
