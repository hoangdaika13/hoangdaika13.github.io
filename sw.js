const CACHE = "hh-identity-portal-v1022";
...
const RUNTIME_ASSETS = [
  ...
  "./galaxy-cosmic-studio.js?v=4", "./galaxy-living-universe.js?v=6", "./galaxy-living-universe.css?v=2", "./galaxy-universe-renderer.mjs?v=6",
