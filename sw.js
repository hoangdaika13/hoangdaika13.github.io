const CACHE = "hh-identity-portal-v650";
...
const RUNTIME_ASSETS = [
  ...
  "./community-admin.css?v=11",
  "./community-admin.js?v=13",
  ...
  "./services/astra-character/AstraCharacterCore.js?v=1",
  "./services/astra-character/CharacterDefinition.js?v=1",
  "./services/astra-character/CharacterAssetValidator.js?v=1",
  "./services/astra-character/SkeletonProfile.js?v=1",
  "./services/astra-character/AnimationRegistry.js?v=1",
  "./services/astra-character/AnimationRetargeter.js?v=1",
  "./services/astra-character/AnimationStateMachine.js?v=1",
  "./services/astra-character/AdditiveAnimationLayer.js?v=1",
  "./services/astra-character/LocomotionController.js?v=1",
  "./services/astra-character/MotionWarping.js?v=1",
  "./services/astra-character/FootPlacementIK.js?v=1",
  "./services/astra-character/FullBodyIK.js?v=1",
  "./services/astra-character/LookAtController.js?v=1",
  "./services/astra-character/WeaponGripSolver.js?v=1",
  "./services/astra-character/CombatMarkerTimeline.js?v=1",
  "./services/astra-character/CombatAnimationController.js?v=1",
  "./services/astra-character/HitReactionController.js?v=1",
  "./services/astra-character/RagdollController.js?v=1",
  "./services/astra-character/FacialPerformanceController.js?v=1",
  "./services/astra-character/LipSyncController.js?v=1",
  "./services/astra-character/SecondaryMotionController.js?v=1",
  "./services/astra-character/ContextualInteractionController.js?v=1",
  "./services/astra-character/CharacterCollisionController.js?v=1",
  "./services/astra-character/CharacterLODController.js?v=1",
  "./services/astra-character/CharacterNetworkReplicator.js?v=1",
  "./services/astra-character/CharacterPerformanceGovernor.js?v=1",
  "./services/astra-character/CinematicCharacterDirector.js?v=1",
  "./services/astra-character/ElementalCharacterIdentity.js?v=1",
  "./services/astra-character/CharacterCustomizationController.js?v=1",
  "./services/astra-character/CharacterDebugOverlay.js?v=1",
  "./services/astra-character/CharacterRuntimeV3.js?v=1",
  "./astral-realms.js?v=96",
