(() => {
  ...
  const ENGINES = Object.freeze({
    ...
    workflow: { api: "HHCreativeAIWorkflow", js: "creative-ai-workflow.js?v=2", css: "creative-ai-workflow.css?v=2" },
    "ai-director": { api: "HHCreativeAIWorkflow", js: "creative-ai-workflow.js?v=2", css: "creative-ai-workflow.css?v=2" },
    "prompt-studio": { api: "HHCreativeAIWorkflow", js: "creative-ai-workflow.js?v=2", css: "creative-ai-workflow.css?v=2" },
