(() => {
  ...
  const ENGINES = Object.freeze({
    ...
    workflow: { api: "HHCreativeAIWorkflow", js: "creative-ai-workflow.js?v=1", css: "creative-ai-workflow.css?v=1" },
    "ai-director": { api: "HHCreativeAIWorkflow", js: "creative-ai-workflow.js?v=1", css: "creative-ai-workflow.css?v=1" },
    "prompt-studio": { api: "HHCreativeAIWorkflow", js: "creative-ai-workflow.js?v=1", css: "creative-ai-workflow.css?v=1" },
