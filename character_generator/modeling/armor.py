...
def _build_chest(
    ...
    for side, sign in _side_pairs():
        ...
        shell = [
            ...
            (sign * 0.199, -0.128, 1.286),
            (sign * 0.181, -0.125, 1.371),
            (sign * 0.119, -0.139, 1.414),
        ...
        objects.append(_panel(
            ...
            [
                ...
                (sign * 0.195, -0.103, 1.403),
                (sign * 0.183, -0.112, 1.358),
    ...
    for side, sign in _side_pairs():
        ...
        objects.append(_panel(
            ...
            [
                ...
                (sign * 0.205, -0.086, 1.393),
                (sign * 0.268, -0.073, 1.348),
                (sign * 0.267, -0.077, 1.255),
                (sign * 0.230, -0.083, 1.206),
        ...
        objects.append(_panel(
            ...
            [
                (sign * 0.269, -0.067, 1.347),
                (sign * 0.278, -0.026, 1.318),
                (sign * 0.270, 0.067, 1.302),
                (sign * 0.247, 0.080, 1.223),
                (sign * 0.229, -0.070, 1.205),
            ],
            (sign, 0.0, 0.0), 0.014,
            frame, collection, white,
            region="shoulder", material_role="ARMOR_WHITE", source_body=source_body,
