      ...
      <main class="hgc-one-screen">
        ...
        <aside class="hgc-info-center" aria-labelledby="hgcInfoTitle">
          ...
          <div class="hgc-info-panels">
            ...
            <section data-hgc-info-panel="progress" role="tabpanel" hidden><div class="hgc-constellation-map" aria-label="Tiến độ thực trên thiết bị"><svg viewBox="0 0 360 210" role="img" aria-label="Chòm sao tiến độ"><path d="M54 142 L180 42 L306 142"/><path class="is-soft" d="M54 142 L306 142"/><g data-hgc-star="creative" transform="translate(54 142)"><circle r="8"/><text x="0" y="30">Sáng tạo</text><text class="value" x="0" y="-16">0%</text></g><g data-hgc-star="learning" transform="translate(180 42)"><circle r="8"/><text x="0" y="30">Học tập</text><text class="value" x="0" y="-16">0%</text></g><g data-hgc-star="work" transform="translate(306 142)"><circle r="8"/><text x="0" y="30">Công việc</text><text class="value" x="0" y="-16">0%</text></g></svg></div><p class="hgc-truth-note">Tính từ hoạt động đã lưu thật trên thiết bị, không dùng xếp hạng giả.</p></section>
          </div>
        </aside>
      </main>
